...
/**
 * functions by Hri7566
 */

Client.prototype.chset = function(obj) {
    this.sendArray([{
        m: "chset",
        set: obj
    }]);
...
Client.prototype.userset = function(obj) {
    this.sendArray([{
        m: "userset",
        set: obj
    }]);
...
Client.prototype.sendChat = function(str) {
    this.sendArray([{
        m: "a",
        message: str
    }]);
...
Client.prototype.setColor = function(str) {
    this.sendArray([{
        m: "userset",
        set: {
            color: str
...
Client.prototype.getCrown = function() {
    this.sendArray([{
        m: "chown",
        id: this.getOwnParticipant().id
    }]);
}
